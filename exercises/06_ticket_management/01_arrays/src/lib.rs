...
impl WeekTemperatures {
    ...
    pub fn set_temperature(&mut self, day: Weekday, temperature: i32) {
        match day {
            Weekday::Monday => self.0[0] = Some(temperature),
            Weekday::Tuesday => self.0[1] = Some(temperature),
            Weekday::Wednesday => self.0[2] = Some(temperature),
            Weekday::Thursday => self.0[3] = Some(temperature),
            Weekday::Friday => self.0[4] = Some(temperature),
            Weekday::Saturday => self.0[5] = Some(temperature),
            Weekday::Sunday => self.0[6] = Some(temperature),
        }
    }
}
